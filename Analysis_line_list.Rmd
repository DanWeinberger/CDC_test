...
#                     sex  +
#                 f(agec, model='iid') +
#                 f(agec2, time_scale, model='iid') +
#                 f(agec3, qtr2, model='iid') +
#                 f(agec4, qtr3, model='iid') +            
#                 f(agec5, qtr4, model='iid') +    
#                 
#                 f(race_recode, model='iid') +
#                 f(race_recode2, time_scale, model='iid') +
#                 f(race_recode3, qtr2, model='iid') +
#                 f(race_recode4, qtr3, model='iid') +            
#                 f(race_recode5, qtr4, model='iid')  
#                 # 
#                 # f(subgroup_combo, model='iid') +
#                 # f(subgroup_combo2, time_scale, model='iid') +
#                 # f(subgroup_combo3, qtr2, model='iid') +
#                 # f(subgroup_combo4, qtr3, model='iid') +            
#                 # f(subgroup_combo5, qtr4, model='iid')   
# 
#               ,
#                                 offset = log_pop,
#                 family='nbinomial', data=ag3,
