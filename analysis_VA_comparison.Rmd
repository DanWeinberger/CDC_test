...
preds_total_wk$region <- sapply(strsplit(as.character(preds_total_wk$age_region_source), "_"),"[", 1)

preds_total_wk$age_group <- sapply(strsplit(as.character(preds_total_wk$age_region_source), "_"),"[", 2)

preds_total_wk$source <- sapply(strsplit(as.character(preds_total_wk$age_region_source), "_"),"[", 3)
